...
* If you experience any file permission problems (error code 0x6), I found that locally rebuilding the image helps
* To use the forked image use `butarca/dst-server` in place of `jamesits/dst-server` 
